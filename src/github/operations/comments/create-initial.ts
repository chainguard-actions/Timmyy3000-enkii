...
/**
 * Create the initial tracking comment when enkii starts working
...
export async function createInitialComment(
  ...
  try {
    ...
    appendFileSync(githubOutput, `enkii_comment_id=${response.data.id}\n`);
